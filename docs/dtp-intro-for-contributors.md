...
Note that DTP has a [demo Web site](https://github.com/dtinit/data-transfer-project/tree/master/distributions/demo-server) that illustrates how to trigger DTP jobs, but this Web site is not run by anybody in production &mdash; it is used for testing, development and to illustrate use of DTP.

The endpoints are defined using a [Jersey TransportBinder](https://github.com/dtinit/data-transfer-project/blob/master/extensions/transport/portability-transport-jettyrest/src/main/java/org/datatransferproject/transport/jettyrest/rest/JerseyTransportBinder.java){:target="blank"}, including endpoints to
* create transfer job
* reserve worker
* get reserved worker
* start transfer job
